...
import { insertContactSchema } from "./contacts";
...
export const insertCompanySchemaCustom = z.object({
  name: z.string(),
  salesOwner: z.string(),
  dataContact: z.string().array(),
  userId: z.string(),
});

export const insertCompanyParams = baseSchema
  .extend({
...
export const insertCompanyParamsCustom = z.object({
  name: z.string(),
  salesOwner: z.string(),
  dataContact: z.array(insertContactSchema),
});
...
export type NewCompanyParamsCustom = z.infer<typeof insertCompanyParamsCustom>;
