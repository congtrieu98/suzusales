    ...
    return (
        <>
                ...
                {table.getFilteredSelectedRowModel().rows.length > 0 &&
                    <AlertDialog>
                        <AlertDialogTrigger asChild>
                            <Button variant="destructive" className="ml-2">Xóa</Button>
                        </AlertDialogTrigger>
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle>
            ...
            <div className="rounded-md border">
                {
                    pending ? <div className="relative pointer-events-none opacity-40 items-center block w-full p-6 bg-white rounded-lg dark:bg-gray-800  dark:hover:bg-gray-700">
                        <Table>
                            <TableHeader>
